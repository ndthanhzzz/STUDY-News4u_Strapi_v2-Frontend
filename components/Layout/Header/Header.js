        ...
        <header className='flex flex-row justify-between border-solid border-2 border-b-blue-700 bg-white font-arial'> 
            ...
            <div className='lg:block hidden my-1 py-4 mx-12'>
                <div className='flex flex-row justify-center text-black w-auto'>
                        ...
                        <Link href='/sign-in' className='mx-3 hover:text-slate-400'> Đăng nhập </Link>
                        <Link href='/sign-up' className='mx-3 hover:text-slate-400'>  Đăng ký </Link>
                </div>
            </div>
            <div className=" mb-5 mt-3 mr-12 relative dropdown inline-block lg:hidden w-auto">
                ...
                <ul className="dropdown-menu w-20 absolute hidden text-gray-700 pt-1">
                    <li className=""><Link className="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block font-small" href={'/sign-in'}>Đăng nhập</Link></li>
                    <li className=""><Link className="bg-gray-200 hover:bg-gray-400 py-2 px-4 block font-small" href={'/sign-up'}>Đăng ký</Link></li>
                    <li className="">
