  ...
  return (
      <div className="bg-white">
        ...
        <section className="sm:mx-40">
            {/* Language */}
            <div className="my-5">
                <span><Button href="/">Vietnamese</Button></span>
                <span><Button href="/">Global</Button></span>
            </div>
            {/* Welcome */}
            ...
            <div className="mr-auto place-self-center lg:col-span-7">
                ...
                <Link href="/home" className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:orange-blue-400 dark:focus:ring-orange-900">
                    Get started reading 
            ...
            <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <Image width={700} height={0} className='rounded-xl' src="/news-cover.jpg" alt="mockup" loading="lazy"/>
            </div>                
            </div>
        </section>
        <Footer/>
